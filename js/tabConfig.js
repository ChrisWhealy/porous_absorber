...
import {
  getInt, getFloat, getCheckbox, getRadio, getInnerHTML, setInt, setFloat, setCheckbox, setRadio
} from "./domAccess.js"
 ...
 *
 * The configuration tab is always present in the DOM even if the user has not explicitly selected that tab.
 * Therefore, these values are always available even if they are not currently visible.
 *********************************************************************************************************************/
const tabConfig = {
  "rb_porous_absorber": [
    ...
    { id: "lock_abs_dims", units: "each", isWasmArg: false, getter: getCheckbox, setter: setCheckbox },
  ],
  "slotted_panel": [
